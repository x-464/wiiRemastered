...
gameElements.forEach(game => {
    game.addEventListener("mouseenter", () => {
        ...
        const wrapperRect = gameGrid.getBoundingClientRect();
        ...
        // gameTitle.innerHTML = game[i].title;

        console.log(currentGameX, currentGameY);

        gameTitleWrapper.style.top = `${currentGameY}px`;
        gameTitleWrapper.style.left = `${currentGameX}px`;
        gameTitleWrapper.style.transform = "translateX(-50%)";
    })
